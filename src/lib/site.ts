...
export const profile: Profile = {
  ...
  experience: [
    ...
    },
    {
      ...
      responsibilities: ["Built practical exercises with Java, JSP, Servlets, SQL and HTML.", "Developed backend and database fundamentals through the assigned training programme.", "Applied cloud-deployment workflows and Git-based source-control practices."],
    ...
    },
    {
      ...
      responsibilities: ["Developed a job-portal application using JSP, Servlets, MySQL and JDBC.", "Deployed the application with AWS Elastic Beanstalk and Amazon RDS.", "Monitored the application with CloudWatch and used GitHub for source control and collaboration."],
